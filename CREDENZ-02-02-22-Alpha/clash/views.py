...
def logout_view(request):
    ...
    attempted=0
    solved=0
    if(len(Submission.objects.filter(p_id=Player.objects.get(user=request.user), q_id=1))):
        attempted+=1
        if(tester.ques1==100):
            solved+=1
    if(len(Submission.objects.filter(p_id=Player.objects.get(user=request.user), q_id=2))):
        attempted+=1
        if(tester.ques2==100):
            solved+=1
    if(len(Submission.objects.filter(p_id=Player.objects.get(user=request.user), q_id=3))):
        attempted+=1
        if(tester.ques3==100):
            solved+=1
    if(len(Submission.objects.filter(p_id=Player.objects.get(user=request.user), q_id=4))):
        attempted+=1
        if(tester.ques4==100):
            solved+=1
    if(len(Submission.objects.filter(p_id=Player.objects.get(user=request.user), q_id=5))):
        attempted+=1
        if(tester.ques5==100):
            solved+=1
    if(len(Submission.objects.filter(p_id=Player.objects.get(user=request.user), q_id=6))):
        attempted+=1
        if(tester.ques6==100):
            solved+=1
    logout(request)
